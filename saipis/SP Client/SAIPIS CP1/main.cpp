...
string adminPathFile = "F:\\Учёба\\курсач\\SP Server\\admin.txt", userPathFile = "user.txt", admin = "Администратор", user = "Пользователь";
AdminMenu aMenu;
UserMenu uMenu;
...
int main() {
	...
	if (connect(Connection, (SOCKADDR*)&addr, sizeof(addr)) != 0) {
		red cout << "Отсутствие соединения с сервером" << endl; white
		return 1;
	}
	int choice = 1;
	while (choice != 0) {
